...
export default function GridResultsPage() {
	...
	const handleDownload = async () => {
		try {
			...
			link.download = `snapgrid-subway-${Date.now()}.png`;
			link.href = dataUrl;
			link.click();
		} catch (err) {
				...
				<div className="relative z-10 max-w-6xl mx-auto">
					...
					<div className={`mt-10 mx-auto w-full ${previewWidthClass}`}>
						<div className="flex flex-row gap-3 sm:gap-4">
							...
							>
								<svg className="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
									<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 17h2a2 0 002-2v-4a2 0 00-2-2H5a2 0 00-2 2v4a2 0 002 2h2m2 4h6a2 0 002-2v-4a2 0 00-2-2H9a2 0 00-2 2v4a2 0 002 2zm8-12V5a2 0 00-2-2H9a2 0 00-2 2v4h10z" />
								</svg>
								Print
							</button>
						</div>
